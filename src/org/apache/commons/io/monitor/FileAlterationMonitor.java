 ...
 * @version $Id: FileAlterationMonitor.java 1304052 2012-03-22 20:55:29Z
 * ggregory $
 * @since 2.0
 */
public final class FileAlterationMonitor implements Runnable
     ...
     *
     * @param interval The amount of time in miliseconds to wait between checks
     * of the file system
     */
     ...
     * thread to finish. A value of zero will wait until the thread is finished
     * (see {@link Thread#join(long)}).
     * @throws Exception if an error occurs initializing the observer
     * @since 2.1
     */
