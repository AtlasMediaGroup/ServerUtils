 ...
 *      observer.addListener(...);
 * </pre> To manually observe a directory, initialize the observer and invoked
 * the {@link #checkAndNotify()} method as required:
 * <pre>
 *      // intialize
 *      observer.init();
 *      ...
 ...
 *      // finished
 *      observer.finish();
 * </pre> Alternatively, register the oberver(s) with a
 * {@link FileAlterationMonitor}, which creates a new thread, invoking the
 * observer at the specified interval:
 * <pre>
 *      long interval = ...
 ...
 *
 * <h2>File Filters</h2>
 * This implementation can monitor portions of the file system by using
 * {@link FileFilter}s to observe only the files and/or directories that are of
 * interest. This makes it more efficient and reduces the noise from
 * <i>unwanted</i> file system events.
 * <p>
 ...
 * @version $Id: FileAlterationObserver.java 1304052 2012-03-22 20:55:29Z
 * ggregory $
 * @since 2.0
 */
