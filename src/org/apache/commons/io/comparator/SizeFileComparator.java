...
public class SizeFileComparator extends AbstractFileComparator implements Serializable
    ...
    /**
     * Construct a file size comparator instance (directories treated as zero
     * size).
     */
     ...
     * contents should be calculated, otherwise {@code false} if directories
     * should be treated as size zero (see
     ...
     * @return a negative value if the first file's length is less than the
     * second, zero if the lengths are the same and a positive value if the
     * first files length is greater than the second file.
     *
     */
