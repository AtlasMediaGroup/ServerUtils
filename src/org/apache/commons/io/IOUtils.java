...
public class IOUtils
     ...
     * int without truncation before using
     * {@link IOUtils#toByteArray(java.io.InputStream, int)} to read into the
     * byte array. (Arrays can have no more than Integer.MAX_VALUE entries
     * anyway)
     *
     * @param input the <code>InputStream</code> to read from
     * @param size the size of <code>InputStream</code>
     * @return the requested byte array
     * @throws IOException if an I/O error occurs or <code>InputStream</code>
    ...
    /**
     * Get the contents of a <code>URLConnection</code> as a
     * <code>byte[]</code>.
     *
