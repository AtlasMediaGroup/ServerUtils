 ...
 * default can lead to unexpected results. <p We don't provide special variants
 * for the <code>copy</code> methods that let you specify the buffer size
 * because in modern VMs the impact on speed seems to be minimal. We're using a
 ...
 * </pre> The rationale is as follows:
 * <p>
 ...
 * IOUtils.write() or IOUtils.copy(). Null handling behaviour changed in IOUtils
 * (null data does not throw NullPointerException).
 */
@Deprecated
