...
public abstract class ProxyReader extends FilterReader
     ...
     * chars that the caller wanted to read (1 for the {@link #read()} method,
     * buffer length for {@link #read(char[])}, etc.) is given as an argument.
     * <p>
     ...
     * successfully. The number of chars returned to the caller (or -1 if the
