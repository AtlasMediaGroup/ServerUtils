...
public class BoundedInputStream extends InputStream
     ...
     * <code>close()</code> method of the underlying stream or {@code false} if
     * it does not.
     */
     ...
     * {@link InputStream}.
     *
     * @param propagateClose {@code true} if calling {@link #close()} propagates
     * to the <code>close()</code> method of the underlying stream or
