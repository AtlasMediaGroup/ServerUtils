...
public class XmlStreamReader extends Reader
    ...
    /**
     * Invokes the underlying reader's <code>read(char[], int, int)</code>
     * method.
     *
    ...
    String calculateRawEncoding(String bomEnc, String xmlGuessEnc,
        ...
        String msg = MessageFormat.format(RAW_EX_2, new Object[]
            {
            bomEnc, xmlGuessEnc, xmlEnc
            });
        throw new XmlStreamReaderException(msg, bomEnc, xmlGuessEnc, xmlEnc);
     ...
     *
     * @param mime The mime type
     * @return true if the mime type belongs to the TEXT XML family, otherwise
     * false
     */
