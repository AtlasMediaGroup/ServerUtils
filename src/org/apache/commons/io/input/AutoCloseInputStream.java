...
public class AutoCloseInputStream extends ProxyInputStream
    ...
    /**
     * Closes the underlying input stream and replaces the reference to it with
     * a {@link ClosedInputStream} instance.
     * <p>
     * This method is automatically called by the read methods when the end of
     * input has been reached.
     * <p>
     * Note that it is safe to call this method any number of times. The
     * original underlying input stream is closed and discarded only once when
     ...
     * mentioned in {@link #close()}, this is a no-op if the stream has already
     * been closed.
     *
