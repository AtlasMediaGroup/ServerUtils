...
public class ProxyWriter extends FilterWriter
    ...
    /**
     * Invokes the delegate's <code>append(CharSequence, int, int)</code>
     * method.
     *
    ...
    /**
     * Invoked by the write methods before the call is proxied. The number of
     * chars to be written (1 for the {@link #write(int)} method, buffer length
     * for {@link #write(char[])}, etc.) is given as an argument.
     * <p>
     * Subclasses can override this method to add common pre-processing
     * functionality without having to override all the write methods. The
