 ...
 * <tt>out2</tt> would have the same result as writing to
 * <tt>out</tt> directly (provided that the byte sequence is legal with respect
 * to the charset encoding):
 * <pre>
 * OutputStream out = ...
 * Charset cs = ...
...
public class WriterOutputStream extends OutputStream
     ...
     * flushed after each write operation, i.e. all available data will be
     * written to the underlying {@link Writer} immediately. If <tt>false</tt>,
