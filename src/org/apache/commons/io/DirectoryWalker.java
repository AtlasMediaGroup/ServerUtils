 ...
 *    FileFilterUtils.suffixFileFilter(".txt"),
 *  );
 * </pre> This is much simpler than the previous example, and is why it is the
 ...
 * implemented.
 * <b>Note</b> the decision logic and throwing a {@link CancelException} could
 * be implemented in any of the <i>lifecycle</i> methods.
 *
 * <pre>
