...
public class FileFilterUtils
     ...
     * <code>files</code> contains a {@code null} value.
     *
     * @since 2.0
     */
     ...
     *
     * @param cutoffReference the file whose last modification time is usesd as
     ...
     *
     * @throws IllegalArgumentException if <code>magicNumber</code> is
     * {@code null} or the empty String, or if offset is a negative number.
     * @see MagicNumberFileFilter
     * @since 2.0
     */
     ...
     *
     * @throws IllegalArgumentException if <code>magicNumber</code> is
     * {@code null}, or contains no bytes, or <code>offset</code> is a negative
     * number.
     * @see MagicNumberFileFilter
     * @since 2.0
     */
     ...
     * {@code null} will return a filter that accepts everything except CVS
     * directories.
     *
     ...
     * {@code null} will return a filter that accepts everything except SVN
     * directories.
     *
     * @param filter the filter to decorate, null means an unrestricted filter
     * @return the decorated filter, never null
