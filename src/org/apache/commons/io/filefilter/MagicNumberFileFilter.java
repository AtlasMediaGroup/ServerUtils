...
public class MagicNumberFileFilter extends AbstractFileFilter implements
     ...
     * </pre>
     *
     * @param magicNumber the magic number to look for in the file. The string
     * is converted to bytes using the platform default charset.
     *
     * @throws IllegalArgumentException if <code>magicNumber</code> is
     ...
     *
     * @throws IllegalArgumentException if <code>magicNumber</code> is
     * {@code null} or the empty String, or <code>offset</code> is a negative
     * number.
     */
     ...
     *
     * @return {@code true} if the file contains the filter's magic number at
     * the specified offset, {@code false} otherwise.
     */
    @Override
