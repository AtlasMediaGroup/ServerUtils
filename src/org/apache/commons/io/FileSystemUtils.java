...
public class FileSystemUtils
     ...
     * </pre> The free space is calculated via the command line. It uses 'dir
     * /-c' on Windows and 'df' on *nix.
     *
     ...
     * </pre> The free space is calculated via the command line. It uses 'dir
     * /-c' on Windows, 'df -kP' on AIX/HP-UX and 'df -k' on other Unix.
     * <p>
     ...
     *
     * @param path the path to get free space for, not null, not empty on Unix
     * @param timeout The timout amount in milliseconds or no timeout if the
